    ...
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Instruments != null ? 
                          ...
                          Problem("Entity set 'CleoUIDbContext.Instruments'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("InstrumentID,InstrumentName,InstrumentCode,InstrumentURL")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstrumentID,InstrumentName,InstrumentCode,InstrumentURL")] Instrument instrument)
        {
